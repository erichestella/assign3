...
save_button=customtkinter.CTkButton(rich,command=save, text="SAVE RECEIPT:", font=font2, text_color="yellow", border_color="violet",fg_color="#2E86C1", corner_radius=20, cursor="hand2")
